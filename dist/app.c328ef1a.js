...
},{"@firebase/storage":"node_modules/@firebase/storage/dist/index.esm.js"}],"node_modules/process/browser.js":[function(require,module,exports) {
...
function () {
  ...
  Repo.prototype.getValue = function (query) {
    ...
    return this.server_.get(query).then(function (payload) {
      ...
      _this.log_('get for query ' + (0, _util.stringify)(query) + ' failed: ' + err);
...
},{"@firebase/database":"node_modules/@firebase/database/dist/index.esm.js"}],"createElement.js":[function(require,module,exports) {
"use strict";
...
function upload(selector) {
  ...
  var preview = (0, _createElement.element)('div', ['preview']);
  var open = (0, _createElement.element)('button', ['btn'], 'Открыть');
  var upload = (0, _createElement.element)('button', ['btn', 'primary'], 'Загрузить на сервер');
  var load = (0, _createElement.element)('button', ['btn', 'loader'], 'Загрузить с сервера');
...
},{"firebase/app":"node_modules/firebase/app/dist/index.esm.js","./createElement":"createElement.js"}],"loadfiles.js":[function(require,module,exports) {
"use strict";
...
},{"firebase/app":"node_modules/firebase/app/dist/index.esm.js","./createElement":"createElement.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
(0, _upload.upload)('#file', {
  ...
  onUpload: function onUpload(files, blocks) {
    files.forEach(function (file, index) {
      ...
      var task = ref.put(file); //Кладем туда сам файл
      // Прослушиваем событие загрузки

      task.on('state_changed', function (snapshot) {
        // Смотрим процент загрузки
        var percent = (snapshot.bytesTransferred / snapshot.totalBytes * 100).toFixed(0); // console.log(percent)

        var block = blocks[index].querySelector('.preview-info-progress');
        block.textContent = "".concat(percent, " %");
        block.style.width = "".concat(percent, "%");
      }, function (error) {
        console.log(error);
      }, function () {
        task.snapshot.ref.getDownloadURL().then(function (url) {
          console.log(url); // Записываем путь в картинку

          var refData = _app.default.database().ref("allImages/".concat(index)).set(url);
        });
      });
    });
  }
});
(0, _loadfiles.load)(['view-table'], database);
},{"firebase/app":"node_modules/firebase/app/dist/index.esm.js","firebase/storage":"node_modules/firebase/storage/dist/index.esm.js","firebase/database":"node_modules/firebase/database/dist/index.esm.js","./upload":"upload.js","./loadfiles":"loadfiles.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
